...
<%@ page import="studentsTable.ArrayListDb" %>
...
<body>
    <div class="container">
        <form action="students" method="post">
            ...
            <input type="number" placeholder="First Name" name="year">
        ...
        <table>
            ...
            <% List<Student> students = ((ArrayListDb)application.getAttribute("my-db")).getAll();
